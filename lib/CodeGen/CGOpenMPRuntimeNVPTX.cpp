...
void CGOpenMPRuntimeNVPTX::emitTargetOutlinedFunction(
  ...
  // FIXME: Remove this when both NV and AMD runtimes can get mode from Kernel Props 
...
llvm::Function *CGOpenMPRuntimeNVPTX::emitRegistrationFunction() {
  ...
  for (auto &DS : DataSharingFunctionInfoMap) {
    ...
    // FIXME This code needs verification because it is not in HCC2 before reverse merge
